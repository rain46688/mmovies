...
import mmovie.mmovie.common.jwt.JwtFilter;
import mmovie.mmovie.common.jwt.TokenProvider;
import mmovie.mmovie.dto.MemberDto;
import mmovie.mmovie.dto.TokenDto;
...
public class AuthController {
    ...
    public ResponseEntity<TokenDto> authorize(@Valid @RequestBody MemberDto memberDto) {
        ...
        log.info("== memberDto.getPassword() : "+memberDto.getPassword());
